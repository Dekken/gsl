...
GSL_VAR gsl_rng *gsl_rng_alloc (const gsl_rng_type * T);
int gsl_rng_memcpy (gsl_rng * dest, const gsl_rng * src);
gsl_rng *gsl_rng_clone (const gsl_rng * r);

GSL_VAR void gsl_rng_free (gsl_rng * r);

GSL_VAR void gsl_rng_set (const gsl_rng * r, unsigned long int seed);
...
GSL_VAR const gsl_rng_type * gsl_rng_env_setup (void);
